...
class Form extends AbstractComponent
{
     ...
     * @return FormGroup
     */
    public function addSubmit(string $name, string $value = null, string $style = null, string $label = null, int $row = 1, int $column = 1)
    {
        return $this->addInput(new Submit($style ?? Submit::STYLE_PRIMARY), $name, $value, $label, $row, $column);
    }
