...
interface BorderAwareInterface
{
    ...
    public const BORDER_POSITION_RIGHT = 'border-end';
    public const BORDER_POSITION_BOTTOM = 'border-bottom';
    public const BORDER_POSITION_LEFT = 'border-start';

    public const ROUNDED_NONE = 'rounded-0';
    public const ROUNDED_DEFAULT = 'rounded';
    public const ROUNDED_SMALL = 'rounded-1';
    public const ROUNDED_MEDIUM = 'rounded-2';
    public const ROUNDED_LARGE = 'rounded-3';
    public const ROUNDED_TOP = 'rounded-top';
    public const ROUNDED_RIGHT = 'rounded-end';
    public const ROUNDED_BOTTOM = 'rounded-bottom';
    public const ROUNDED_LEFT = 'rounded-start';
