            ...
            'bundles' => [
                ...
                'list' => [
                    [
                        ...
                        'sources' => [
                            __DIR__ . '/../bundles/src/vendor/01-jquery.min.js',
                            __DIR__ . '/../bundles/src/vendor/02-bootstrap.bundle.min.js',
                            __DIR__ . '/../bundles/src/vendor/03-bs-custom-file-input.min.js',
                            __DIR__ . '/../bundles/src/vendor/04-popper.min.js',
                            __DIR__ . '/../bundles/src/vendor/05-quill.min.js',
                            __DIR__ . '/../bundles/src/vendor/06-moment.js',
                            __DIR__ . '/../bundles/src/vendor/07-daterangepicker.js',
